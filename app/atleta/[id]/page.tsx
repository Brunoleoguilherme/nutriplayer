...
export default function AtletaHome() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100dvh-64px)]">
      ...
      {/* ── Header com gradiente (coluna esquerda no desktop) ── */}
      <div
        className="relative overflow-hidden px-5 pt-8 pb-10 lg:w-80 lg:min-h-[calc(100dvh-64px)] lg:flex lg:flex-col lg:justify-between lg:shrink-0"
      ...
      >
        ...
        {/* Rodapé do painel esquerdo (só desktop) */}
        <div className="hidden lg:block relative z-10 mt-8">
          <p className="text-xs text-white/30 text-center">NutriPlayer · {atleta?.posicao || "Atleta"}</p>
        </div>
      </div>

      {/* ── Cards de acesso rápido (coluna direita / grid no desktop) ── */}
      <div className="flex-1 bg-[var(--color-bg)] px-4 pt-5 pb-4">
        <div className="space-y-3 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-4 lg:h-full lg:content-start lg:pt-2">
